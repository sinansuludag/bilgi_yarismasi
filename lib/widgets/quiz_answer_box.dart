...
class MyQuizAnswerBox extends ConsumerStatefulWidget {
  const MyQuizAnswerBox(
      ...
      required this.text1,
      required this.text2,
      required this.index1,required this.index2});
  final Color color1;
  final Color color2;
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _MyQuizAnswerBoxState();
}
        ...
        children: [
          Expanded(
            ...
            child: TextButton(
              ...
              child: Text(widget.text1, style: TextStyle(color: Colors.white)),
            ),
          )),
          const SizedBox(
            width: 5,
